...
$this->title = \Yii::t('app', 'Board Room');
$this->params['breadcrumbs'][] = ['label' => \Yii::t('app', 'Board Room'), 'url' => ['/site/banquet']];
$this->params['breadcrumbs'][] = $this->title;
$this->params['model'] = 'feature-board';
    ...
    <div class="row">
        <div class="col-sm-6">
             <?php 
                ...
                <?php endforeach; */ ?>
                <?= Html::img('@web/images/features/DSC_4017m.jpg') ?>
                <?= Html::img('@web/images/features/DSC_4020m.jpg') ?>
                <?php $fotorama->end(); ?>
        </div>
        <div class="col-sm-6">
